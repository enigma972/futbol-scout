 ...
 */
final class Version20191115011006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, promo_clip_id INT DEFAULT NULL, picture_id INT NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, nickname VARCHAR(100) NOT NULL, birthday DATETIME DEFAULT NULL, gender VARCHAR(10) NOT NULL, country VARCHAR(255) NOT NULL, length INT DEFAULT NULL, weight INT DEFAULT NULL, strong_feets LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', postes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', current_club VARCHAR(255) DEFAULT NULL, status VARCHAR(100) DEFAULT NULL, ambition LONGTEXT DEFAULT NULL, biographie LONGTEXT DEFAULT NULL, level VARCHAR(100) DEFAULT NULL, nb_fans INT NOT NULL, nb_notices INT NOT NULL, pseudo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_98197A65366D5797 (promo_clip_id), UNIQUE INDEX UNIQ_98197A65EE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, avatar_id INT DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, mail VARCHAR(100) NOT NULL, phone VARCHAR(20) DEFAULT NULL, created_at DATETIME NOT NULL, birthday DATETIME NOT NULL, gender VARCHAR(10) NOT NULL, country VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, is_complete TINYINT(1) NOT NULL, nb_followers INT NOT NULL, nb_follows INT NOT NULL, UNIQUE INDEX UNIQ_8D93D6495126AC48 (mail), UNIQUE INDEX UNIQ_8D93D649444F97DD (phone), UNIQUE INDEX UNIQ_8D93D64986383B10 (avatar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
